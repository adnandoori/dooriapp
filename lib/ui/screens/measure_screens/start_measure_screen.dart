...
class StartMeasureScreen extends StatelessWidget {
  const StartMeasureScreen({super.key});


  @override
  Widget build(BuildContext context) {
    return GetBuilder<StartMeasureController>(
        init: StartMeasureController(context),
        builder: (controller) {
          return Scaffold(
                    ...
                    Transform.scale(
                      ...
                      child: Container(
                        ...
                        child: WaveWidget(
                          config: CustomConfig(
                            colors: [
                              controller.state ==  BluetoothConnectionState.connected && controller.isFingerDetected
...
Widget widgetProgressLoderDialog(StartMeasureController controller) {
  return Align(
                  ...
                  child: Column(
                    ...
                    children: [
                      InkWell(
                        onTap: () {},
                        child: Text(
                          (controller.state == BluetoothConnectionState.connected)?
                          controller.dialogTitle["init"]!
                              :(controller.state == BluetoothConnectionState.connecting?
                          controller.dialogTitle["connecting"]!: "connecting".tr),// "loading".tr),
      ...
      /*Card(
      margin: EdgeInsets.only(top: 250.h, left: 30.w, right: 30.w),
      color: Colors.red,
      child: Center(
        child: Container(
          padding: EdgeInsets.only(top: 20.w, left: 20.w, right: 20.w),
